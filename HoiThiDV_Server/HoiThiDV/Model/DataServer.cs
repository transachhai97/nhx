...
namespace HoiThiDV.Model
{
    ...
    public class DataServer
    {
        ...
        public List<int> questRoundBC { get; set; }
        public List<int> questRoundBC_phu { get; set; }
        public List<int> questRoundBC_hungbien { get; set; }
        public List<int> questRoundBC_duphongvong1 { get; set; }
        public List<int> questRoundBC_duphongvong2 { get; set; }
