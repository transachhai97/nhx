...
namespace HoiThiDV
{
    public class MasterController
    {
        ...
        private BanGiamKhao viewBanGiamKhao; 
        ...
        public MasterController(Form1 v)
        {
            ...
            // Set up BanGiamKhao view
            this.viewBanGiamKhao = new BanGiamKhao();
            this.viewBanGiamKhao.setController(this);
                ...
                if (obj is DataServer)
                {
                    ...
                    else if (data.Round == 1)
                    {
                        ...
                        else if (data.Action.Equals(Constant.ACTION_RESET_ALL))
                        {
                            ...
                            this.viewTangToc.InitTangToc(data);
                    ...
                    else if (data.Round == 3)// show đáp án đội thi khởi động
                    {
                        if (data.ContestTeams.Count == 5)
                        {
                            this.showTeamAnswer25();
                    ...
                    {
                        //if (data.Action.Equals(Constant.ACTION_RESET))
                        //{
                        //    if (data.oneTeam == 0)
                        //    {
                        //        this.showTeam6();
        ...
        public void showBanGiamKhao()
        {
            this.view.addUserControl(viewBanGiamKhao);
        }
