...
{
    public partial class TimeTeam5 : UserControl
    {
        ...
        public void resetForm(DataServer data)
        {
            ...
            if (data != null && data.ContestTeams != null)
            {
                ...
                {
                    R3_Answer1.Text = data.ContestTeams[0].Name + " (0)";
                    R3_Team1.Text = data.ContestTeams[0].Answer;
                    R3_Time1.Text = string.IsNullOrEmpty(data.ContestTeams[0].Time) ? "" : data.ContestTeams[0].Time + " s";
                }
                if (data.ContestTeams.Count > 1)
                {
                    R3_Answer2.Text = data.ContestTeams[1].Name + " (0)";
                ...
                {
                    R3_Answer3.Text = data.ContestTeams[2].Name + " (0)";
                ...
                {
                    R3_Answer4.Text = data.ContestTeams[3].Name + " (0)";
                ...
                {
                    R3_Answer5.Text = data.ContestTeams[4].Name + " (0)";
