...
{
    public partial class TeamAnswer26_BC : UserControl
    {
        private MasterController ctrl;
        private string score = "0";
        private SoundPlayer mo_dap_an;
        public TeamAnswer26_BC()
        {
            InitializeComponent();
            loadFile();
            _lblAnswer.Text = "";
        ...
        public void resetForm(DataServer data)
        {
            ...
            if (data != null && data.ContestTeams != null)
            {
                ...
                {
                    R3_Team5.Text = data.ContestTeams[4].Name ;
                ...
                {
                    R3_Team6.Text = data.ContestTeams[5].Name;
                    R3_Answer6.Text = data.ContestTeams[5].Answer;
                    R3_Time6.Text = string.IsNullOrEmpty(data.ContestTeams[5].Time) ? "" : data.ContestTeams[4].Time + " s";
                }
            }
        }
        public void bonusPoint(DataServer data)
        {
            if (data.team == 0)
            {
                resetForm(data);
        ...
        public void showBell(DataServer data)
        {
            ...
            else
            {
                ...
                if (pos != 0)
                {
                    SetTextComp("R3_Team" + pos, nameTeam);
                    CompBackColor("R3_Team" + pos, Color.FromArgb(0, 102, 255));//màu xanh
                    CompForeColor("R3_Team" + pos, Color.White);//màu trắng
                }
            }
        ...
        private void TeamAnswer26BC_Load(object sender, EventArgs e)
        {
